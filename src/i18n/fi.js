...
const translations = {
  ...
  'mobilityPlatform.menu.show.busStops': 'Linja-autopysäkit',
  ...
  'mobilityPlatform.info.busStops': 'Kartalla näkyvät Turun seudun joukkoliikenteen Fölin linja-autopysäkit. Kuvaketta painamalle voi nähdä seuraavat pysäkiltä lähtevät vuorot. Tarkenna karttaa lähemmäs, jotta pysäkit näkyvät. Tiedot tulevat Digitransitin ylläpitämästä rajapinnasta.', // TODO: verify
