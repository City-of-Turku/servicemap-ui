...
const translations = {
  ...
  'mobilityPlatform.info.airMonitoring.paragraph.2': 'The calculation takes into account sulfur dioxide (SO2), nitrogen dioxide (NO2), inhalable particles (PM10), fine particles (PM2.5), and ozone (O3). When air quality is poor or very poor, health effects are possible, especially for sensitive individuals. Factors contributing to poor air quality include street dust, traffic emissions, wood burning, energy production, and occasional long-range transport.', // TODO verify
  'mobilityPlatform.info.airMonitoring.paragraph.3': 'The air quality information on the Service map is obtained from the air protection collaboration group of Turku.', // TODO verify
